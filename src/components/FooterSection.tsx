      ...
      <div className="max-w-5xl mx-auto text-center space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 pb-4">
          ...
          >
            ...
            <span className="block text-[10px] mt-2 text-gold/60 group-hover:text-gold transition-colors font-display tracking-[0.2em] font-bold uppercase text-center">CALL</span>
          </a>
